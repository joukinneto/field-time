...
The official timesheet PDF now reads persisted Supervisor Center review state and maps it back to each Field Time work segment through the deterministic entry id `field-{workDayId}-{segmentId}`.
